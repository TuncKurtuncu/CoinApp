    ...
    <div>
      ...
      <div className='grid justify-center items-center'>
        <div className='m-auto mt-20 flex items-center'>
            ...
            <span className=' text-4xl text-red-600'>Top 10 Losers</span>
        </div>
        <div className=' container m-auto mt-20'>
            <TopMovers onLoserLoaded={(losers) => setLosersData(losers)} hideUI={true} losersCount={10}/>
                <table className='w-full table-fixed text-white p-2'>
                    ...
                    <tbody>
                        {loasersData.length > 0 ? (
                            loasersData.map((coin) =>(
